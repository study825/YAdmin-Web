...
export default {
  ...
  methods: {
    getList() {
      ...
      industryList(this.listQuery).then((response) => {
    ...
    handleUpdate(row) {
      ...
      this.dialogCreate = true;
      industryDetail(row.id).then((res) => {
        this.temp.id = res.data.id;
        this.temp.name = res.data.name;
      });
    },
    createData() {
      createIndustry(this.temp).then((res) => {
        this.dialogCreate = false;
        this.getList();
      });
    },
    updateData() {
      updateIndustry(this.temp).then((res) => {
        this.dialogCreate = false;
        this.getList();
      });
    },
    handleDelete(row, index) {
      ...
      deleteIndustry(this.delete_ids).then((response) => {
